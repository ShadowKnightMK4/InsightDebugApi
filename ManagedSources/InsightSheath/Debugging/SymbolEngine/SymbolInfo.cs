...
namespace InsightSheath.Debugging.SymbolEngine
{
    ...
    public class SymbolInfo : NativeStaticContainer
    {
        ...
        public uint TypeDataIndex
        {
            get
            {
                return SymbolInfoInternal.SymbolInfo_GetTypeIndex(Native);
            }
        }
        ...
        public uint SymbolIndex
        {
            get
            {
                return SymbolInfoInternal.SymbolInfo_GetIndex(Native);
            }
        }
        ...
        public uint SymbolSize
        {
            get
            {
                return SymbolInfoInternal.SymbolInfo_GetSymbolSize(Native);
            }
        }
        ...
        public ulong BaseModuleAddress
        {
            get
            {
                return SymbolInfoInternal.SymbolInfo_GetModuleBase(Native);
            }
        }
        ...
        public SymbolFlags Flags
        {
            get
            {
                return SymbolInfoInternal.SymbolInfo_GetFlags(Native);
            }
        }
        ...
        public uint SymbolRegisterOrValue
        {
            get
            {
                return SymbolInfoInternal.SymbolInfo_GetValOrReg(Native);
            }
        }
        ...
        public uint SymbolRegister
        {
            get
            {
                return SymbolInfoInternal.SymbolInfo_GetReg(Native);
            }
        }
        ...
        public uint SymbolValue
        {
            get
            {
                return SymbolInfoInternal.SymbolInfo_GetVal(Native);
            }
        }
        ...
        public uint SymbolScope
        {
            get
            {
                return SymbolInfoInternal.SymbolInfo_GetScope(Native);
            }
        }
        ...
        public SymbolTagType SymbolTagType
        {
            get
            {
                return SymbolInfoInternal.SymbolInfo_GetTagType(Native);
            }
        }
        ...
        public string SymbolName
        {
            get
            {
                return Marshal.PtrToStringUni(SymbolInfoInternal.SymbolInfo_GetName(Native));
            }
        }
