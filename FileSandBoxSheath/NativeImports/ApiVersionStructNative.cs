...
namespace InsightSheath.NativeImports
{
    ...
    {
        [DllImport("FileSandBoxApi.dll", BestFitMapping = false, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Winapi, EntryPoint = "DebugHelp_ApiVerionStruct_GetRevision", ExactSpelling = false)]
        public static extern ushort DebugHelp_ApiVerion_GetRevision(IntPtr that);
        [DllImport("FileSandBoxApi.dll", BestFitMapping = false, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Winapi, EntryPoint = "DebugHelp_ApiVerionStruct_GetMajor", ExactSpelling = false)]
        public static extern ushort DebugHelp_ApiVerion_GetMajor(IntPtr that);
        [DllImport("FileSandBoxApi.dll", BestFitMapping = false, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Winapi, EntryPoint = "DebugHelp_ApiVerionStruct_GetMinor", ExactSpelling = false)]
