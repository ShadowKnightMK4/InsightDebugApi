...
namespace InsightSheath.NativeImports
{
    ...
    internal static partial class NativeMethods
    {
        ...
        /// <param name="That"></param>
        /// <returns></returns>
        [DllImport("FileSandBoxApi.dll", BestFitMapping = false, CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Unicode, EntryPoint = "ThreadContext_GetTargetThreadId")]
        public static extern uint ThreadContext_GetTargetThreadId(IntPtr That);


        [DllImport("FileSandBoxApi.dll", BestFitMapping = false, CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Unicode, EntryPoint = "ThreadContext_GetIdealProcessor")]
        public static extern uint ThreadContext_GetIdealProcessor(IntPtr That);

        
        [DllImport("FileSandBoxApi.dll", BestFitMapping = false, CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Unicode, EntryPoint = "ThreadContext_SetIdealProcessor")]
        public static extern uint ThreadContext_SetIdealProcessor(IntPtr That, uint NewIdealProcessor);


        [DllImport("FileSandBoxApi.dll", BestFitMapping = false, CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Unicode, EntryPoint = "ThreadContext_GetThreadPriorityBoostSetting")]
        public static extern bool ThreadContext_GetThreadPriorityBoostSetting(IntPtr That);

        [DllImport("FileSandBoxApi.dll", BestFitMapping = false, CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Unicode, EntryPoint = "ThreadContext_SetThreadPriorityBoostSetting")]
        public static extern bool ThreadContext_SetThreadPriorityBoostSetting(IntPtr That, bool EnablePriorityBoost);

        [DllImport("FileSandBoxApi.dll", BestFitMapping = false, CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Unicode, EntryPoint = "ThreadContext_GetThreadProcessAffinityMask")]
        public static extern uint ThreadContext_GetThreadProcessAffinityMask(IntPtr That);


        [DllImport("FileSandBoxApi.dll", BestFitMapping = false, CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Unicode, EntryPoint = "ThreadContext_SetThreadProcessAffinityMask")]
