...
#pragma region ArraysAndMore
	...
	/// <summary>
	/// Read an array of ULONG_PTR size values from tehe passed process
	/// </summary>
	/// <param name="Process">Process to read from (0=GetCurrentProcess()), A true</param>
...
#pragma endregion
	...
	/// <summary>
	/// Read an arbitrary size of memory from the passed process at Target Location in it's address and return it typecast to a void*
	/// </summary>
	...
	/// <summary>
	/// Read the OBJECT_ATTRIBUTES from the passed location in the remote process DOES NOT COPY THE SECURITY DESCRIPTORS to calling processs. The pointers are still relevent in the remote process
	/// </summary>
